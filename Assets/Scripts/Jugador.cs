...
public class Jugador : MonoBehaviour
{
    ...
    private void Awake()
    {
        _objectSelect = FindObjectOfType<ObjectSelect>();
    ...
    private void Gun()
    {
        if (_objectSelect.isActiveAndEnabled && Input.GetKeyDown(KeyCode.F) && _objectSelect.objetoEnMano) // Agrega la condición de objetoEnMano
        {
